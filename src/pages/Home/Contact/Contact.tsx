...
const ContactSection = () => {
  return (
    <div className="relative bg-primary flex flex-col sm:flex-row justify-between">
      <p></p>
      ...
      <div className="sm:absolute sm:inset-0 w-full sm:h-full flex flex-col sm:flex-row gap-y-12 text-white py-12 sm:py-20 sm:px-32 px-4 justify-between items-center ">
        ...
        <div className="w-full sm:w-1/2 pr-8">
          <h2 className="text-4xl font-bold mb-4">Don't hesitate to reach <br className="hidden sm:block" /> out to us</h2>
        ...
        {/* Right Column */}
        <div className="w-full sm:w-[45%] bg-white text-gray-800 rounded-lg p-4 py-5">
