...
function Benefits() {
  ...
  const benefits = [
    { icon: '/assets/icons/wallet.svg', title: "20 Crypto Wallets", content: "KWIQ provides all its users with more than twenty different wallets to deposit, buy, sell, store, swap and send crypto instantly." },
