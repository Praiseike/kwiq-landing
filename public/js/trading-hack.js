    ...
    new (class extends class {
      ...
      _replaceScript(i) {
        ...
        (this.iframeContainer = h && f ? h : document.createElement("div")),
          ...
          (o && this._validateSettings()) || (console.error("Invalid settings provided, fall back to defaults"), (this.settings = this.filterRawSettings(this.defaultSettings)));
        const w = "32px",
        ...
        (this.iframe = this._createIframe(C, c, a, L, E)), this._addCSPErrorListener(c), u && this.iframe.setAttribute("nonce", u);
        const I = this.iframeContainer.querySelector(".tradingview-widget-container__widget");
        if (
          (I
            ? ((0, t.ensureNotNull)(I.parentElement).replaceChild(this.iframe, I), null == n || n.remove())
            : f
              ? (this.iframeContainer.appendChild(this.iframe), null == n || n.remove())
              : (this.iframeContainer.appendChild(this.iframe), h.replaceChild(this.iframeContainer, (0, t.ensureNotNull)(n))),
            ...
            (function (t, e, i) {
              ...
              t.width && ((this.iframe.style.width = t.width + "px"), (this.iframeContainer.style.width = t.width + "px")),
      ...
      _createIframe(t, e, i, r, n) {
        ...
        return this._setSettingsQueryString(o), this._setHashString(o, i), s.setAttribute("src", o.toString()), (s.title = r), (s.lang = n), s;
      }
        ...
        if (this._copyrightContainer) {
          ...
          if (r) {
            ...
            if (n)
              try {
                const s = new URL(n);
                s.searchParams.set("utm_source", t), s.searchParams.set("utm_medium", e), s.searchParams.set("utm_campaign", i), r.setAttribute("href", s.toString());
              } catch (t) {
